...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='../YOLOS-PV/data/', type=str)
...
def main(args):
    ...
    if args.resume:
        ...
        checkpoint['model']['class_embed.layers.2.weight'] = checkpoint['model']['class_embed.layers.2.weight'][:model_without_ddp.class_embed.layers[2].weight.shape[0], :] 
        checkpoint['model']['class_embed.layers.2.bias'] = checkpoint['model']['class_embed.layers.2.bias'][:model_without_ddp.class_embed.layers[2].bias.shape[0]]  
